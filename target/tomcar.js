...
define("tom/radar", ["require", "exports", "core/sensor"], function (require, exports, sensor_1) {
    ...
    exports.DEFAULT_RADAR_INSTANCE = new Radar(10, 120, 2 * Math.PI / 3);
});
...
define("factory", ["require", "exports", "tom/brain", "tom/fertari", "tom/radar", "tom/tom"], function (require, exports, brain_1, fertari_1, radar_3, tom_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function GetTomCar(locationX, locationY, velocityX, velocityY) {
        // init brain
        var tomBrain = new brain_1.default();
        tomBrain.InitBrain(radar_3.DEFAULT_RADAR_INSTANCE.scanLine, 10, 10, 3);
        // init driver
        ...
        tomCar.SetSensorUseDefaultName(radar_3.DEFAULT_RADAR_INSTANCE);
        return {
            car: tomCar,
            driver: tomDriver,
            brain: tomBrain,
...
define("workflow", ["require", "exports", "core/env", "tom/radar", "tom/tom"], function (require, exports, env_1, radar_4, tom_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class GAWorkFlow {
        ...
        ExecuteStrategicPlan() {
            ...
            for (var i = 0; i < halfNum; i++) {
                ...
                if (driverA instanceof tom_2.default &&
                    driverB instanceof tom_2.default) {
            ...
            for (var i = 0; i < this.cars.length; i++) {
                ...
                if (driver instanceof tom_2.default) {
...
define("tomcar", ["require", "exports", "workflow", "factory"], function (require, exports, workflow_1, factory_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.GetGAWorkFlow = exports.TomCarStart = void 0;
